...
def initiateDf():
	...
	FYTechAll = FY[FY['Service Line Group'] == 'Technology'][FY['Close Period'] >= '2018 - 01'].copy()

	return FYTechAll

	# generateTable(FYTechAll)
	# pipePlots(FYTechAll)
	# keyDeals(FY, FYTechAll)
	# SlPlot(FYTechAll)
	# dealSizePlot(FYTechAll)
	# closeReasonPlot(FYTechAll)
	# averageAgePlot(FYTechAll)
